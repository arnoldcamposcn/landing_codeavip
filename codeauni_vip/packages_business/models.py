...
class CursoBusiness(models.Model):
    ...
    tipo_entrega = models.CharField(max_length=20, choices=ENTREGA_CHOICES, blank=True, null=True, default='')
    tipo_contenido = models.CharField(max_length=20, choices=CONTENIDO_CHOICES, blank=True, null=True, default='')
    dias_disponibles = MultiSelectField(choices=DIAS_SEMANA, blank=True, null=True)
...
class Temario(models.Model):
    ...
    curso = models.ForeignKey(CursoBusiness, on_delete=models.CASCADE, related_name='temarios')
