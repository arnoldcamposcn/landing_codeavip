...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('packages_business', '0001_initial'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tema', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cursos_business', to='packages_business.temabusiness')),
            ],
        ),
